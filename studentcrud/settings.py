...
SECRET_KEY = os.environ.get('SECRET_KEY', 'c1v)(20r^-190@cfbjq@d7m65z=(5f#gq@ocwb8j8+ol+78u2)')
...
# Add the line below for static files collection (when running `collectstatic`)
